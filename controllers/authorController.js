...
exports.author_create_post = [
    ...
    function (req, res, next) {
        ...
        if (!errors.isEmpty()) {
            ...
            req.body.date_of_birth_field = req.body.date_of_birth;
            req.body.date_of_death_field = req.body.date_of_death;
            res.render('author_form', { title: 'Create Author', author: req.body, errors: errors.array() });
            return;
        }
        else {
            // re-sanitize date fields
            sanitizeBody('date_fo_birth').toDate();
            sanitizeBody('date_fo_death').toDate();
